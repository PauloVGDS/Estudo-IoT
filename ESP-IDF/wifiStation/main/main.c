...
void event_handler(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data) {
    ...
    if (event_base == WIFI_EVENT || event_base == IP_EVENT) {
        ...
        case IP_EVENT_STA_GOT_IP:
            ...
            ESP_LOGI(TAG, "IP:" IP2STR, IP2STR(&ip_info->ip));
            break;
        ...
        case WIFI_EVENT_STA_CONNECTED:
            ...
            ESP_LOGI(TAG, "BSSID da Rede: " MAC2STR, (wifi_struct->bssid)[0], (wifi_struct->bssid)[1], (wifi_struct->bssid)[2], (wifi_struct->bssid)[3], (wifi_struct->bssid)[4], (wifi_struct->bssid)[5]);
            break;
        default:
